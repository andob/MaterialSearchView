...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener
{
    ...
    public int minimumNumberOfCharacters = 1;
...
//            }
    ...
    private void onSubmitQuery()
    {
        ...
        if (query!=null&&TextUtils.getTrimmedLength(query)>=minimumNumberOfCharacters)
        {
    ...
    /**
     * Call this method to withTwoButtons suggestions list. This shows up when adapter is set. Call {@link #setAdapter(ListAdapter)} before calling this.
     */
    ...
    /**
     * if withTwoButtons is true, this will enable voice search. If voice is not available on the device, this method call has not effect.
     *
     * @param show
     */
